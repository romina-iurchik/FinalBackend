...
-- Insertar Catalogo
INSERT INTO Catalogo (idCatalogo, resumen, temporadas, idPosterCatalogo, idTrailerCatalogo, idCategoriaCatalogo, idGeneroCatalogo, titulo)
VALUES (
  3,
...
SELECT 3, idTag FROM Tag WHERE tagName = 'Sci-Fi';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 3, idTag FROM Tag WHERE tagName = 'Fantasía';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 3, idTag FROM Tag WHERE tagName = 'Acción';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 3, idActor FROM Actor WHERE actorName = 'Pedro Pascal';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 3, idActor FROM Actor WHERE actorName = 'Carl Weathers';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 3, idActor FROM Actor WHERE actorName = 'Misty Rosas';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 3, idActor FROM Actor WHERE actorName = 'Chris Bartlett';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 3, idActor FROM Actor WHERE actorName = 'Rio Hackford';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 3, idActor FROM Actor WHERE actorName = 'Giancarlo Esposito';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 4, idTag FROM Tag WHERE tagName = 'Sci-Fi';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 4, idTag FROM Tag WHERE tagName = 'Fantasía';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 4, idTag FROM Tag WHERE tagName = 'Drama';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 4, idActor FROM Actor WHERE actorName = 'Tom Hopper';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 4, idActor FROM Actor WHERE actorName = 'David Castañeda';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 4, idActor FROM Actor WHERE actorName = 'Emmy Raver-Lampman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 4, idActor FROM Actor WHERE actorName = 'Robert Sheehan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 4, idActor FROM Actor WHERE actorName = 'Aidan Gallagher';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 4, idActor FROM Actor WHERE actorName = 'Elliot Page';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 5, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 5, idTag FROM Tag WHERE tagName = 'Ficción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 5, idTag FROM Tag WHERE tagName = 'Sucesos';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 5, idActor FROM Actor WHERE actorName = 'Anya Taylor-Joy';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 5, idActor FROM Actor WHERE actorName = 'Thomas Brodie-Sangster';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 5, idActor FROM Actor WHERE actorName = 'Harry Melling';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 5, idActor FROM Actor WHERE actorName = 'Moses Ingram';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 5, idActor FROM Actor WHERE actorName = 'Chloe Pirrie';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 5, idActor FROM Actor WHERE actorName = 'Janina Elkin';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 2, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 2, idTag FROM Tag WHERE tagName = 'Misterio';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 2, idTag FROM Tag WHERE tagName = 'Ficción';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 2, idActor FROM Actor WHERE actorName = 'Lili Reinhart';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 2, idActor FROM Actor WHERE actorName = 'Casey Cott';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 2, idActor FROM Actor WHERE actorName = 'Camila Mendes';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 2, idActor FROM Actor WHERE actorName = 'Marisol Nichols';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 2, idActor FROM Actor WHERE actorName = 'Madelaine Petsch';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 2, idActor FROM Actor WHERE actorName = 'Mädchen Amick';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 1, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 1, idTag FROM Tag WHERE tagName = 'Suceso Real';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 1, idActor FROM Actor WHERE actorName = 'Claire Fox';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 1, idActor FROM Actor WHERE actorName = 'Olivia Colman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 1, idActor FROM Actor WHERE actorName = 'Matt Smith';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 1, idActor FROM Actor WHERE actorName = 'Tobias Menzies';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 1, idActor FROM Actor WHERE actorName = 'Vanesa Kirby';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 1, idActor FROM Actor WHERE actorName = 'Helena Bonham Carter';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 6, idTag FROM Tag WHERE tagName = 'Ficción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 6, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 6, idTag FROM Tag WHERE tagName = 'Misterio';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 6, idActor FROM Actor WHERE actorName = 'Millie Bobby Brown';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 6, idActor FROM Actor WHERE actorName = 'Henry Cavill';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 6, idActor FROM Actor WHERE actorName = 'Sam Claflin';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 6, idActor FROM Actor WHERE actorName = 'Helena Bonham Carter';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 6, idActor FROM Actor WHERE actorName = 'Louis Partridge';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 6, idActor FROM Actor WHERE actorName = 'Adeel Akhtar';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 7, idTag FROM Tag WHERE tagName = 'Crimen';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 7, idTag FROM Tag WHERE tagName = 'Suspenso';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 7, idActor FROM Actor WHERE actorName = 'Joaquin Phoenix';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 7, idActor FROM Actor WHERE actorName = 'Robert De Niro';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 7, idActor FROM Actor WHERE actorName = 'Zazie Beetz';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 7, idActor FROM Actor WHERE actorName = 'Frances Conroy';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 7, idActor FROM Actor WHERE actorName = 'Brett Cullen';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 7, idActor FROM Actor WHERE actorName = 'Shea Whigham';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 8, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 8, idTag FROM Tag WHERE tagName = 'Sci-Fi';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 8, idTag FROM Tag WHERE tagName = 'Acción';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 8, idActor FROM Actor WHERE actorName = 'Robert Downey Jr.';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 8, idActor FROM Actor WHERE actorName = 'Chris Evans';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 8, idActor FROM Actor WHERE actorName = 'Mark Ruffalo';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 8, idActor FROM Actor WHERE actorName = 'Chris Hemsworth';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 8, idActor FROM Actor WHERE actorName = 'Scarlett Johansson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 8, idActor FROM Actor WHERE actorName = 'Jeremy Renner';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 9, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 9, idTag FROM Tag WHERE tagName = 'Fantasía';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 9, idTag FROM Tag WHERE tagName = 'Drama';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 9, idActor FROM Actor WHERE actorName = 'Emilia Clarke';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 9, idActor FROM Actor WHERE actorName = 'Lena Headey';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 9, idActor FROM Actor WHERE actorName = 'Sophie Turner';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 9, idActor FROM Actor WHERE actorName = 'Kit Harington';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 9, idActor FROM Actor WHERE actorName = 'Peter Dinklage';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 9, idActor FROM Actor WHERE actorName = 'Nikolaj Coster-Waldau';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 10, idTag FROM Tag WHERE tagName = 'Sci-Fi';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 10, idTag FROM Tag WHERE tagName = 'Fantasía';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 10, idTag FROM Tag WHERE tagName = 'Acción';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 10, idActor FROM Actor WHERE actorName = 'Grant Gustin';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 10, idActor FROM Actor WHERE actorName = 'Carlos Valdes';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 10, idActor FROM Actor WHERE actorName = 'Danielle Panabaker';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 10, idActor FROM Actor WHERE actorName = 'Candice Patton';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 10, idActor FROM Actor WHERE actorName = 'Jesse L. Martin';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 10, idActor FROM Actor WHERE actorName = 'Tom Cavanagh';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 11, idTag FROM Tag WHERE tagName = 'Comedia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 11, idTag FROM Tag WHERE tagName = 'Fantasía';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 11, idTag FROM Tag WHERE tagName = 'Ficción';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 11, idActor FROM Actor WHERE actorName = 'Jim Parsons';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 11, idActor FROM Actor WHERE actorName = 'Johnny Galecki';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 11, idActor FROM Actor WHERE actorName = 'Kaley Cuoco';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 11, idActor FROM Actor WHERE actorName = 'Simon Helberg';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 11, idActor FROM Actor WHERE actorName = 'Kunal Nayyar';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 11, idActor FROM Actor WHERE actorName = 'Melissa Rauch';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 11, idActor FROM Actor WHERE actorName = 'Mayim Bialik';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 12, idTag FROM Tag WHERE tagName = 'Comedia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 12, idTag FROM Tag WHERE tagName = 'Familia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 12, idTag FROM Tag WHERE tagName = 'Drama';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 12, idActor FROM Actor WHERE actorName = 'Jennifer Aniston';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 12, idActor FROM Actor WHERE actorName = 'Courteney Cox';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 12, idActor FROM Actor WHERE actorName = 'Lisa Kudrow';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 12, idActor FROM Actor WHERE actorName = 'David Schwimmer';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 12, idActor FROM Actor WHERE actorName = 'Matthew Perry';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 12, idActor FROM Actor WHERE actorName = 'Matt LeBlanc';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 13, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 13, idTag FROM Tag WHERE tagName = 'Familia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 13, idTag FROM Tag WHERE tagName = 'Western';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 13, idActor FROM Actor WHERE actorName = 'Amybeth McNulty';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 13, idActor FROM Actor WHERE actorName = 'Geraldine James';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 13, idActor FROM Actor WHERE actorName = 'R. H. Thomson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 13, idActor FROM Actor WHERE actorName = 'Corrine Koslo';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 13, idActor FROM Actor WHERE actorName = 'Dalila Bela';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 13, idActor FROM Actor WHERE actorName = 'Lucas Jade Zumann';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 14, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 14, idTag FROM Tag WHERE tagName = 'Sci-Fi';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 14, idTag FROM Tag WHERE tagName = 'Suspenso';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 14, idActor FROM Actor WHERE actorName = 'Gillian Anderson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 14, idActor FROM Actor WHERE actorName = 'David Duchovny';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 14, idActor FROM Actor WHERE actorName = 'Mitch Pileggi';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 14, idActor FROM Actor WHERE actorName = 'Robert Patrick';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 14, idActor FROM Actor WHERE actorName = 'Tom Braidwood';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 14, idActor FROM Actor WHERE actorName = 'Bruce Harwood';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 15, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 15, idTag FROM Tag WHERE tagName = 'Suceso Real';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 15, idActor FROM Actor WHERE actorName = 'Jared Harris';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 15, idActor FROM Actor WHERE actorName = 'Stellan Skarsgård';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 15, idActor FROM Actor WHERE actorName = 'Emily Watson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 15, idActor FROM Actor WHERE actorName = 'Paul Ritter';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 15, idActor FROM Actor WHERE actorName = 'Jessie Buckley';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 15, idActor FROM Actor WHERE actorName = 'Adam Nagaitis';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 16, idTag FROM Tag WHERE tagName = 'Western';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 16, idTag FROM Tag WHERE tagName = 'Sci-Fi';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 16, idTag FROM Tag WHERE tagName = 'Drama';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Evan Rachel Wood';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Thandiwe Newton';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Jeffrey Wright';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Tessa Thompson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Ed Harris';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Luke Hemsworth';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Rodrigo Santoro';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Simon Quarterman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Clifton Collins Jr.';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Anthony Hopkins';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Ingrid Bolsø Berdal';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Angela Sarafyan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Shannon Woodward';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Talulah Riley';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Louis Herthum';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Ben Barnes';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Jimmi Simpson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Leonardo Nam';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Aaron Paul';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Vincent Cassel';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Izabella Alvarez';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 16, idActor FROM Actor WHERE actorName = 'Jeff Daniel Phillips';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 17, idTag FROM Tag WHERE tagName = 'Ficción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 17, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 17, idTag FROM Tag WHERE tagName = 'Tecnología';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 17, idActor FROM Actor WHERE actorName = 'Lee Pace';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 17, idActor FROM Actor WHERE actorName = 'Scoot McNairy';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 17, idActor FROM Actor WHERE actorName = 'Mackenzie Davis';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 17, idActor FROM Actor WHERE actorName = 'Kerry Bishé';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 17, idActor FROM Actor WHERE actorName = 'Toby Huss';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 17, idActor FROM Actor WHERE actorName = 'Alana Cavanaugh';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 18, idTag FROM Tag WHERE tagName = 'Acción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 18, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 18, idTag FROM Tag WHERE tagName = 'Suspenso';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 18, idActor FROM Actor WHERE actorName = 'Jessica Chastain';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 18, idActor FROM Actor WHERE actorName = 'John Malkovich';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 18, idActor FROM Actor WHERE actorName = 'Colin Farrell';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 18, idActor FROM Actor WHERE actorName = 'Common';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 18, idActor FROM Actor WHERE actorName = 'Geena Davis';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 18, idActor FROM Actor WHERE actorName = 'Ioan Gruffudd';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 19, idTag FROM Tag WHERE tagName = 'Acción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 19, idTag FROM Tag WHERE tagName = 'Ficción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 19, idTag FROM Tag WHERE tagName = 'Comedia';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 19, idActor FROM Actor WHERE actorName = 'Margot Robbie';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 19, idActor FROM Actor WHERE actorName = 'Ewan McGregor';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 19, idActor FROM Actor WHERE actorName = 'Mary Elizabeth Winstead';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 19, idActor FROM Actor WHERE actorName = 'Jurnee Smollett';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 19, idActor FROM Actor WHERE actorName = 'Rosie Perez';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 19, idActor FROM Actor WHERE actorName = 'Chris Messina';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 20, idTag FROM Tag WHERE tagName = 'Acción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 20, idTag FROM Tag WHERE tagName = 'Sci-Fi';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 20, idTag FROM Tag WHERE tagName = 'Suspenso';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 20, idActor FROM Actor WHERE actorName = 'Stacy Martin';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 20, idActor FROM Actor WHERE actorName = 'Rhona Mitra';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 20, idActor FROM Actor WHERE actorName = 'Theo James';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 20, idActor FROM Actor WHERE actorName = 'Peter Ferdinando';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 20, idActor FROM Actor WHERE actorName = 'Lia Williams';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 20, idActor FROM Actor WHERE actorName = 'Toby Jones';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 22, idTag FROM Tag WHERE tagName = 'Sci-Fi';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 22, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 22, idTag FROM Tag WHERE tagName = 'Futurista';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 22, idActor FROM Actor WHERE actorName = 'Miranda Cosgrove';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 22, idActor FROM Actor WHERE actorName = 'Kate Walsh';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 22, idActor FROM Actor WHERE actorName = 'Omar Epps';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 22, idActor FROM Actor WHERE actorName = 'Angus Macfadyen';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 22, idActor FROM Actor WHERE actorName = 'Jorja Fox';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 22, idActor FROM Actor WHERE actorName = 'Enver Gjokaj';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 23, idTag FROM Tag WHERE tagName = 'Terror';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 23, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 23, idTag FROM Tag WHERE tagName = 'Fantasía';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 23, idActor FROM Actor WHERE actorName = 'Bill Skarsgård';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 23, idActor FROM Actor WHERE actorName = 'Jessica Chastain';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 23, idActor FROM Actor WHERE actorName = 'Bill Hader';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 23, idActor FROM Actor WHERE actorName = 'James McAvoy';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 23, idActor FROM Actor WHERE actorName = 'Isaiah Mustafa';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 23, idActor FROM Actor WHERE actorName = 'Jay Ryan';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 24, idTag FROM Tag WHERE tagName = 'Acción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 24, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 24, idTag FROM Tag WHERE tagName = 'Fantasía';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 24, idActor FROM Actor WHERE actorName = 'Chadwick Boseman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 24, idActor FROM Actor WHERE actorName = 'Michael B. Jordan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 24, idActor FROM Actor WHERE actorName = 'Lupita Nyong''o';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 24, idActor FROM Actor WHERE actorName = 'Danai Gurira';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 24, idActor FROM Actor WHERE actorName = 'Martin Freeman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 24, idActor FROM Actor WHERE actorName = 'Daniel Kaluuya';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 25, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 25, idTag FROM Tag WHERE tagName = 'Historia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 25, idTag FROM Tag WHERE tagName = 'Aventura';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 25, idActor FROM Actor WHERE actorName = 'Christian Bale';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 25, idActor FROM Actor WHERE actorName = 'Matt Damon';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 25, idActor FROM Actor WHERE actorName = 'Caitriona Balfe';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 25, idActor FROM Actor WHERE actorName = 'Josh Lucas';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 25, idActor FROM Actor WHERE actorName = 'Noah Jupe';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 25, idActor FROM Actor WHERE actorName = 'Jon Bernthal';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 26, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 26, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 26, idTag FROM Tag WHERE tagName = 'Intriga';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 26, idActor FROM Actor WHERE actorName = 'Génesis Rodríguez';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 26, idActor FROM Actor WHERE actorName = 'Vincent Piazza';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 26, idActor FROM Actor WHERE actorName = 'Benjamin Sokolow';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 26, idActor FROM Actor WHERE actorName = 'Emily Bayiokos';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 27, idTag FROM Tag WHERE tagName = 'Terror';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 27, idTag FROM Tag WHERE tagName = 'Acción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 27, idTag FROM Tag WHERE tagName = 'Sci-Fi';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 27, idTag FROM Tag WHERE tagName = 'Futurista';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 27, idActor FROM Actor WHERE actorName = 'Amy Manson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 27, idActor FROM Actor WHERE actorName = 'Luke Allen-Gale';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 27, idActor FROM Actor WHERE actorName = 'Nina Bergman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 27, idActor FROM Actor WHERE actorName = 'Dominic Mafham';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 27, idActor FROM Actor WHERE actorName = 'James Weber Brown';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 27, idActor FROM Actor WHERE actorName = 'Lorina Kamburova';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 28, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 28, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 28, idTag FROM Tag WHERE tagName = '¿Ficción?';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 28, idActor FROM Actor WHERE actorName = 'Marion Cotillard';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 28, idActor FROM Actor WHERE actorName = 'Matt Damon';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 28, idActor FROM Actor WHERE actorName = 'Laurence Fishburne';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 28, idActor FROM Actor WHERE actorName = 'Jude Law';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 28, idActor FROM Actor WHERE actorName = 'Kate Winslet';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 28, idActor FROM Actor WHERE actorName = 'Jennifer Ehle';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 28, idActor FROM Actor WHERE actorName = 'Gwyneth Paltrow';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 29, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 29, idTag FROM Tag WHERE tagName = 'Acción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 29, idTag FROM Tag WHERE tagName = 'Aventura';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 29, idActor FROM Actor WHERE actorName = 'Scarlett Johansson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 29, idActor FROM Actor WHERE actorName = 'Florence Pugh';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 29, idActor FROM Actor WHERE actorName = 'David Harbour';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 29, idActor FROM Actor WHERE actorName = 'O.T. Fagbenle';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 29, idActor FROM Actor WHERE actorName = 'Rachel Weisz';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 29, idActor FROM Actor WHERE actorName = 'William Hurt';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 29, idActor FROM Actor WHERE actorName = 'Ray Winstone';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 30, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 30, idTag FROM Tag WHERE tagName = 'Sci-Fi';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 30, idTag FROM Tag WHERE tagName = 'Aventura';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 30, idActor FROM Actor WHERE actorName = 'Matt Damon';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 30, idActor FROM Actor WHERE actorName = 'Jessica Chastain';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 30, idActor FROM Actor WHERE actorName = 'Kristen Wiig';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 30, idActor FROM Actor WHERE actorName = 'Jeff Daniels';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 30, idActor FROM Actor WHERE actorName = 'Michael Peña';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 30, idActor FROM Actor WHERE actorName = 'Sean Bean';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 30, idActor FROM Actor WHERE actorName = 'Kate Mara';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 31, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 31, idTag FROM Tag WHERE tagName = 'Sci-Fi';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 31, idTag FROM Tag WHERE tagName = 'Suspenso';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 31, idActor FROM Actor WHERE actorName = 'Alicia Vikander';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 31, idActor FROM Actor WHERE actorName = 'Domhnall Gleeson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 31, idActor FROM Actor WHERE actorName = 'Oscar Isaac';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 31, idActor FROM Actor WHERE actorName = 'Sonoya Mizuno';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 31, idActor FROM Actor WHERE actorName = 'Corey Johnson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 31, idActor FROM Actor WHERE actorName = 'Claire Selby';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 31, idActor FROM Actor WHERE actorName = 'Gana Bayarsaikhan';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 32, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 32, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 32, idTag FROM Tag WHERE tagName = 'Ficción';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 32, idActor FROM Actor WHERE actorName = 'Bryce Dallas Howard';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 32, idActor FROM Actor WHERE actorName = 'Chris Pratt';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 32, idActor FROM Actor WHERE actorName = 'Irrfan Khan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 32, idActor FROM Actor WHERE actorName = 'Vincent D''Onofrio';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 32, idActor FROM Actor WHERE actorName = 'Omar Sy';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 32, idActor FROM Actor WHERE actorName = 'Nick Robinson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 32, idActor FROM Actor WHERE actorName = 'Judy Greer';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 33, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 33, idTag FROM Tag WHERE tagName = 'Terror';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 33, idTag FROM Tag WHERE tagName = 'Ficción';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 33, idActor FROM Actor WHERE actorName = 'Will Smith';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 33, idActor FROM Actor WHERE actorName = 'Alice Braga';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 33, idActor FROM Actor WHERE actorName = 'Charlie Tahan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 33, idActor FROM Actor WHERE actorName = 'Dash Mihok';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 33, idActor FROM Actor WHERE actorName = 'Salli Richardson-Whitfield';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 33, idActor FROM Actor WHERE actorName = 'Willow Smith';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 33, idActor FROM Actor WHERE actorName = 'Emma Thompson';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 34, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 34, idTag FROM Tag WHERE tagName = 'Suceso Real';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 34, idActor FROM Actor WHERE actorName = 'Ryan Gosling';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 34, idActor FROM Actor WHERE actorName = 'Claire Foy';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 34, idActor FROM Actor WHERE actorName = 'Jason Clarke';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 34, idActor FROM Actor WHERE actorName = 'Kyle Chandler';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 34, idActor FROM Actor WHERE actorName = 'Corey Stoll';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 34, idActor FROM Actor WHERE actorName = 'Patrick Fugit';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 35, idTag FROM Tag WHERE tagName = 'Acción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 35, idTag FROM Tag WHERE tagName = 'Fantasía';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 35, idTag FROM Tag WHERE tagName = 'Sci-Fi';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 35, idActor FROM Actor WHERE actorName = 'John Boyega';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 35, idActor FROM Actor WHERE actorName = 'Scott Eastwood';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 35, idActor FROM Actor WHERE actorName = 'Cailee Spaeny';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 35, idActor FROM Actor WHERE actorName = 'Jing Tian';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 35, idActor FROM Actor WHERE actorName = 'Rinko Kikuchi';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 35, idActor FROM Actor WHERE actorName = 'Burn Gorman';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 36, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 36, idTag FROM Tag WHERE tagName = 'Historia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 36, idTag FROM Tag WHERE tagName = 'Tecnología';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 36, idActor FROM Actor WHERE actorName = 'Ahston Kutcher';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 36, idActor FROM Actor WHERE actorName = 'Dermot Mulroney';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 36, idActor FROM Actor WHERE actorName = 'Josh Gad';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 36, idActor FROM Actor WHERE actorName = 'Lukas Haas';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 36, idActor FROM Actor WHERE actorName = 'Matthew Modine';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 36, idActor FROM Actor WHERE actorName = 'J.K. Simmons';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 36, idActor FROM Actor WHERE actorName = 'Lesley Ann Warren';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 37, idTag FROM Tag WHERE tagName = 'Tecnología';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 37, idTag FROM Tag WHERE tagName = 'Historia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 37, idTag FROM Tag WHERE tagName = 'Comedia';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 37, idActor FROM Actor WHERE actorName = 'Noah Wyle';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 37, idActor FROM Actor WHERE actorName = 'Anthony Michael';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 37, idActor FROM Actor WHERE actorName = 'Joey Slotnick';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 37, idActor FROM Actor WHERE actorName = 'J.G. Hertzler';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 37, idActor FROM Actor WHERE actorName = 'Wayne Pére';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 37, idActor FROM Actor WHERE actorName = 'Sheila Shaw';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 37, idActor FROM Actor WHERE actorName = 'Gemma Zamprogna';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 37, idActor FROM Actor WHERE actorName = 'John DiMaggio';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 38, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 38, idTag FROM Tag WHERE tagName = 'Historia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 38, idTag FROM Tag WHERE tagName = 'Tecnología';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 38, idActor FROM Actor WHERE actorName = 'Jesse Eisenberg';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 38, idActor FROM Actor WHERE actorName = 'Andrew Garfield';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 38, idActor FROM Actor WHERE actorName = 'Justin Timberlake';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 38, idActor FROM Actor WHERE actorName = 'Armie Hammer';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 38, idActor FROM Actor WHERE actorName = 'Max Minghella';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 38, idActor FROM Actor WHERE actorName = 'Rooney Mara';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 38, idActor FROM Actor WHERE actorName = 'Brenda Song';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 38, idActor FROM Actor WHERE actorName = 'Rashida Jones';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 38, idActor FROM Actor WHERE actorName = 'John Gertz';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 39, idTag FROM Tag WHERE tagName = 'Acción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 39, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 39, idTag FROM Tag WHERE tagName = 'Drama';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 39, idActor FROM Actor WHERE actorName = 'Ryan Phillippe';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 39, idActor FROM Actor WHERE actorName = 'Rachael Leigh Cook';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 39, idActor FROM Actor WHERE actorName = 'Tim Robbins';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 39, idActor FROM Actor WHERE actorName = 'Claire Forlani';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 39, idActor FROM Actor WHERE actorName = 'Richard Rountree';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 39, idActor FROM Actor WHERE actorName = 'Tygh Runyan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 39, idActor FROM Actor WHERE actorName = 'Ned Bellamy';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 39, idActor FROM Actor WHERE actorName = 'Tyler Labine';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 40, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 40, idTag FROM Tag WHERE tagName = 'Ciencia ficción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 40, idTag FROM Tag WHERE tagName = 'Suspenso';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 40, idActor FROM Actor WHERE actorName = 'Anna Kendrick';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 40, idActor FROM Actor WHERE actorName = 'Daniel Dae Kim';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 40, idActor FROM Actor WHERE actorName = 'Shamier Anderson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 40, idActor FROM Actor WHERE actorName = 'Toni Collette';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 41, idTag FROM Tag WHERE tagName = 'Acción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 41, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 41, idTag FROM Tag WHERE tagName = 'Ciencia ficción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 41, idTag FROM Tag WHERE tagName = 'Fantasía';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 41, idActor FROM Actor WHERE actorName = 'Ben Affleck';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 41, idActor FROM Actor WHERE actorName = 'Henry Cavill';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 41, idActor FROM Actor WHERE actorName = 'Gal Gadot';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 41, idActor FROM Actor WHERE actorName = 'Jason Momoa';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 41, idActor FROM Actor WHERE actorName = 'Ezra Miller';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 41, idActor FROM Actor WHERE actorName = 'Ray Fisher';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 41, idActor FROM Actor WHERE actorName = 'Amy Adams';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 41, idActor FROM Actor WHERE actorName = 'Jeremy Irons';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 41, idActor FROM Actor WHERE actorName = 'Connie Nielsen';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 42, idTag FROM Tag WHERE tagName = 'Familia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 42, idTag FROM Tag WHERE tagName = 'Comedia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 42, idTag FROM Tag WHERE tagName = 'Aventura';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 42, idActor FROM Actor WHERE actorName = 'Charlie Sheen';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 42, idActor FROM Actor WHERE actorName = 'Jon Cryer';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 42, idActor FROM Actor WHERE actorName = 'Angus T. Jones';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 42, idActor FROM Actor WHERE actorName = 'Conchata Ferrel';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 42, idActor FROM Actor WHERE actorName = 'Holland Taylor';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 42, idActor FROM Actor WHERE actorName = 'Marin Hinkle';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 42, idActor FROM Actor WHERE actorName = 'Jennifer Bini Taylor';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 42, idActor FROM Actor WHERE actorName = 'Melanie Lynskey';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 42, idActor FROM Actor WHERE actorName = 'Ashton Kutcher';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 42, idActor FROM Actor WHERE actorName = 'Amber Tamblyn';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 43, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 43, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 43, idTag FROM Tag WHERE tagName = 'Acción';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 43, idActor FROM Actor WHERE actorName = 'Úrsula Corberó';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 43, idActor FROM Actor WHERE actorName = 'Álvaro Morte';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 43, idActor FROM Actor WHERE actorName = 'Itziar Ituño';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 43, idActor FROM Actor WHERE actorName = 'Pedro Alonso';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 43, idActor FROM Actor WHERE actorName = 'Alba Flores';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 43, idActor FROM Actor WHERE actorName = 'Miguel Herrán';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 43, idActor FROM Actor WHERE actorName = 'Jaime Lorente';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 43, idActor FROM Actor WHERE actorName = 'Esther Acebo';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 43, idActor FROM Actor WHERE actorName = 'Enrique Arce';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 44, idTag FROM Tag WHERE tagName = 'Misterio';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 44, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 44, idTag FROM Tag WHERE tagName = 'Familia';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 44, idActor FROM Actor WHERE actorName = 'Winona Ryder';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 44, idActor FROM Actor WHERE actorName = 'David Harbour';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 44, idActor FROM Actor WHERE actorName = 'Finn Wolfhard';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 44, idActor FROM Actor WHERE actorName = 'Millie Bobby Brown';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 44, idActor FROM Actor WHERE actorName = 'Gaten Matarazzo';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 44, idActor FROM Actor WHERE actorName = 'Caleb McLaughlin';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 44, idActor FROM Actor WHERE actorName = 'Natalia Dyer';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 44, idActor FROM Actor WHERE actorName = 'Charlie';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 44, idActor FROM Actor WHERE actorName = 'Heaton';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 44, idActor FROM Actor WHERE actorName = 'Joe Keery';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 45, idTag FROM Tag WHERE tagName = 'Ciencia ficción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 45, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 45, idTag FROM Tag WHERE tagName = 'Drama';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 45, idActor FROM Actor WHERE actorName = 'Sandra Bullock';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 45, idActor FROM Actor WHERE actorName = 'George Clooney';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 45, idActor FROM Actor WHERE actorName = 'Ed Harris';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 45, idActor FROM Actor WHERE actorName = 'Orto Ignatiussen';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 45, idActor FROM Actor WHERE actorName = 'Phaldut Sharma';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 45, idActor FROM Actor WHERE actorName = 'Amy Warren';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 45, idActor FROM Actor WHERE actorName = 'Basher Savage';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 45, idActor FROM Actor WHERE actorName = 'Adam Cozens';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 49, idTag FROM Tag WHERE tagName = 'Terror';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 49, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 49, idTag FROM Tag WHERE tagName = 'Drama';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 49, idActor FROM Actor WHERE actorName = 'Jaeden Martell';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 49, idActor FROM Actor WHERE actorName = 'Jeremy Ray';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 49, idActor FROM Actor WHERE actorName = 'Sophia Lillis';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 49, idActor FROM Actor WHERE actorName = 'Finn Wolfhard';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 49, idActor FROM Actor WHERE actorName = 'Chosen Jacobs';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 49, idActor FROM Actor WHERE actorName = 'Jack Dylan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 49, idActor FROM Actor WHERE actorName = 'Wyatt Oleff';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 49, idActor FROM Actor WHERE actorName = 'Bill Skarsgård';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 49, idActor FROM Actor WHERE actorName = 'Nicholas Hamilton';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 46, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 46, idTag FROM Tag WHERE tagName = 'Historia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 46, idTag FROM Tag WHERE tagName = 'Suceso Real';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 46, idActor FROM Actor WHERE actorName = 'Tom Hanks';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 46, idActor FROM Actor WHERE actorName = 'Bill Paxton';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 46, idActor FROM Actor WHERE actorName = 'Kevin Bacon';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 46, idActor FROM Actor WHERE actorName = 'Gary Sinise';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 46, idActor FROM Actor WHERE actorName = 'Ed Harris';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 46, idActor FROM Actor WHERE actorName = 'Kathleen Quinlan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 46, idActor FROM Actor WHERE actorName = 'Roger Corman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 46, idActor FROM Actor WHERE actorName = 'Chris Ellis';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 46, idActor FROM Actor WHERE actorName = 'Xander Berkeley';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 47, idTag FROM Tag WHERE tagName = 'Terror';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 47, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 47, idTag FROM Tag WHERE tagName = 'Drama';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 47, idActor FROM Actor WHERE actorName = 'Liev Schreiber';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 47, idActor FROM Actor WHERE actorName = 'Julia Stiles';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 47, idActor FROM Actor WHERE actorName = 'Seamus Davey-Fitzpatrick';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 47, idActor FROM Actor WHERE actorName = 'David Thewils';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 47, idActor FROM Actor WHERE actorName = 'Pete Postlethwaite';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 47, idActor FROM Actor WHERE actorName = 'Mia Farrow';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 47, idActor FROM Actor WHERE actorName = 'Predrag Bjelac';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 47, idActor FROM Actor WHERE actorName = 'Carlo Sabatini';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 47, idActor FROM Actor WHERE actorName = 'Amy Huck';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 48, idTag FROM Tag WHERE tagName = 'Terror';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 48, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 48, idTag FROM Tag WHERE tagName = 'Drama';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 48, idActor FROM Actor WHERE actorName = 'Ellen Burstyn';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 48, idActor FROM Actor WHERE actorName = 'Linda Blair';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 48, idActor FROM Actor WHERE actorName = 'Max vox Sydow';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 48, idActor FROM Actor WHERE actorName = 'Lee J. Cobb';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 48, idActor FROM Actor WHERE actorName = 'Kitty Winn';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 48, idActor FROM Actor WHERE actorName = 'Jack MacGowran';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 48, idActor FROM Actor WHERE actorName = 'Jason Miller';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 48, idActor FROM Actor WHERE actorName = 'William O''Malley';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 48, idActor FROM Actor WHERE actorName = 'Barton Heyman';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 50, idTag FROM Tag WHERE tagName = 'Comedia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 50, idTag FROM Tag WHERE tagName = 'Familia';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 50, idActor FROM Actor WHERE actorName = 'Rainn Wilson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 50, idActor FROM Actor WHERE actorName = 'Steve Carell';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 50, idActor FROM Actor WHERE actorName = 'Jenna Fischer';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 50, idActor FROM Actor WHERE actorName = 'John Krasinski';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 50, idActor FROM Actor WHERE actorName = 'B.J. Novak';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 50, idActor FROM Actor WHERE actorName = 'Kate Flannery';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 50, idActor FROM Actor WHERE actorName = 'Brian Baumgartner';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 50, idActor FROM Actor WHERE actorName = 'Leslie David Baker';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 50, idActor FROM Actor WHERE actorName = 'Mindy Kaling';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 50, idActor FROM Actor WHERE actorName = 'Angela Kinsey';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 51, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 51, idTag FROM Tag WHERE tagName = 'Familia';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 51, idActor FROM Actor WHERE actorName = 'Freddie Highmore';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 51, idActor FROM Actor WHERE actorName = 'Antonia Thomas';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 51, idActor FROM Actor WHERE actorName = 'Hill Harper';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 51, idActor FROM Actor WHERE actorName = 'Richard Schiff';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 51, idActor FROM Actor WHERE actorName = 'Christina Chang';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 51, idActor FROM Actor WHERE actorName = 'Paige Spara';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 51, idActor FROM Actor WHERE actorName = 'Fiona Gubelmann';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 51, idActor FROM Actor WHERE actorName = 'Will Yun Lee';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 51, idActor FROM Actor WHERE actorName = 'Nicholas Gonzalez';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 52, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 52, idTag FROM Tag WHERE tagName = 'Romance';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 52, idTag FROM Tag WHERE tagName = 'Suceso Real';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 52, idActor FROM Actor WHERE actorName = 'Eddie Redmayne';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 52, idActor FROM Actor WHERE actorName = 'Felicity Jones';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 52, idActor FROM Actor WHERE actorName = 'Charlie Cox';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 52, idActor FROM Actor WHERE actorName = 'Emily Watson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 52, idActor FROM Actor WHERE actorName = 'Simon McBurney';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 52, idActor FROM Actor WHERE actorName = 'David Thewlis';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 52, idActor FROM Actor WHERE actorName = 'Maxine Peake';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 52, idActor FROM Actor WHERE actorName = 'Harry Lloyd';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 52, idActor FROM Actor WHERE actorName = 'Tom Prior';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 53, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 53, idTag FROM Tag WHERE tagName = 'Historia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 53, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 53, idTag FROM Tag WHERE tagName = 'Suceso Real';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 53, idActor FROM Actor WHERE actorName = 'Benedict Cumberbatch';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 53, idActor FROM Actor WHERE actorName = 'Keira Knightley';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 53, idActor FROM Actor WHERE actorName = 'Matthew Goode';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 53, idActor FROM Actor WHERE actorName = 'Rory Kinnear';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 53, idActor FROM Actor WHERE actorName = 'Allen Leech';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 53, idActor FROM Actor WHERE actorName = 'Matthew Beard';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 53, idActor FROM Actor WHERE actorName = 'Charles Dance';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 53, idActor FROM Actor WHERE actorName = 'Mark Strong';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 53, idActor FROM Actor WHERE actorName = 'James Northcote';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 54, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 54, idTag FROM Tag WHERE tagName = 'Historia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 54, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 54, idTag FROM Tag WHERE tagName = 'Suceso Real';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 54, idActor FROM Actor WHERE actorName = 'Taraji P. Henson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 54, idActor FROM Actor WHERE actorName = 'Octavia Spencer';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 54, idActor FROM Actor WHERE actorName = 'Janelle Monáe';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 54, idActor FROM Actor WHERE actorName = 'Kevin Costner';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 54, idActor FROM Actor WHERE actorName = 'Kirsten Dunst';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 54, idActor FROM Actor WHERE actorName = 'Jim Parsons';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 54, idActor FROM Actor WHERE actorName = 'Mahershala Ali';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 54, idActor FROM Actor WHERE actorName = 'Glen Powell';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 54, idActor FROM Actor WHERE actorName = 'Ariana Neal';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 55, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 55, idTag FROM Tag WHERE tagName = 'Historia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 55, idTag FROM Tag WHERE tagName = 'Romance';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 55, idTag FROM Tag WHERE tagName = 'Suceso Real';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 55, idActor FROM Actor WHERE actorName = 'Russell Crowe';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 55, idActor FROM Actor WHERE actorName = 'Jennifer Connelly';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 55, idActor FROM Actor WHERE actorName = 'Ed Harris';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 55, idActor FROM Actor WHERE actorName = 'Paul Bettany';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 55, idActor FROM Actor WHERE actorName = 'Christopher Plummer';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 55, idActor FROM Actor WHERE actorName = 'Josh Lucas';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 55, idActor FROM Actor WHERE actorName = 'Adam Goldberg';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 55, idActor FROM Actor WHERE actorName = 'Anthony Rapp';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 55, idActor FROM Actor WHERE actorName = 'Judd Hirsch';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 56, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 56, idTag FROM Tag WHERE tagName = 'Romance';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 56, idTag FROM Tag WHERE tagName = 'Sci-Fi';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 56, idTag FROM Tag WHERE tagName = 'Ciencia Ficción';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 56, idActor FROM Actor WHERE actorName = 'Jennifer Lawrence';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 56, idActor FROM Actor WHERE actorName = 'Chris Pratt';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 56, idActor FROM Actor WHERE actorName = 'Michael Sheen';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 56, idActor FROM Actor WHERE actorName = 'Laurence Fishburne';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 56, idActor FROM Actor WHERE actorName = 'Andy García';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 56, idActor FROM Actor WHERE actorName = 'Aurora Perrineau';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 56, idActor FROM Actor WHERE actorName = 'Kristin Brock';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 56, idActor FROM Actor WHERE actorName = 'Julee Cerda';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 56, idActor FROM Actor WHERE actorName = 'Fred Melamed';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 57, idTag FROM Tag WHERE tagName = 'Misterio';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 57, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 57, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 57, idTag FROM Tag WHERE tagName = 'Romance';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 57, idActor FROM Actor WHERE actorName = 'Anne Hathaway';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 57, idActor FROM Actor WHERE actorName = 'Patrick Wilson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 57, idActor FROM Actor WHERE actorName = 'Andre Braugher';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 57, idActor FROM Actor WHERE actorName = 'Dianne Wiest';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 57, idActor FROM Actor WHERE actorName = 'David Morse';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 57, idActor FROM Actor WHERE actorName = 'William B. Davis';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 57, idActor FROM Actor WHERE actorName = 'Ryan Robbins';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 57, idActor FROM Actor WHERE actorName = 'Clea DuVall';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 57, idActor FROM Actor WHERE actorName = 'Don Thompson';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 58, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 58, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 58, idTag FROM Tag WHERE tagName = 'Suceso Real';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 58, idActor FROM Actor WHERE actorName = 'Ben Affleck';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 58, idActor FROM Actor WHERE actorName = 'Bryan Cranston';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 58, idActor FROM Actor WHERE actorName = 'Alan Arkin';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 58, idActor FROM Actor WHERE actorName = 'Jogn Goodman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 58, idActor FROM Actor WHERE actorName = 'Victor Garber';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 58, idActor FROM Actor WHERE actorName = 'Tate Donovan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 58, idActor FROM Actor WHERE actorName = 'Clea DuVall';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 58, idActor FROM Actor WHERE actorName = 'Scoot McNairy';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 58, idActor FROM Actor WHERE actorName = 'Rory Cochrane';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 58, idActor FROM Actor WHERE actorName = 'Kerry Bishé';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 59, idTag FROM Tag WHERE tagName = 'Ciencia Ficción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 59, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 59, idTag FROM Tag WHERE tagName = 'Misterio';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'Noomi Rapace';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'Michael Fassbender';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'Charlize Theron';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'Logan Marshall-Green';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'Guy Pearce';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'Idris Elba';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'Sean Harris';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'Rafe Spall';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'Kate Dickie';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'Emut Elliott';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'Benedict Wong';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'Lucy Hutchinson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'Patrick Wilson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'Ian Whyte';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'Branwell Donaghey';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'Vladimir Furdik';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'C.C. Smiff';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'Shane Steyn';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 59, idActor FROM Actor WHERE actorName = 'John Lebar';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 60, idTag FROM Tag WHERE tagName = 'Ciencia Ficción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 60, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 60, idTag FROM Tag WHERE tagName = 'Misterio';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Michael Fassbender';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Katherine Waterston';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Billy Crudup';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Danny McBride';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Demián Bichir';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Carmen Ejogo';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Jussie Smollett';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Callie Hernandez';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Amy Seimetz';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Nathaniel Dean';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Alexander England';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Benjamin Rigby';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Uli Latukefu';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Tess Haubrich';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Andrew Crawford';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Guy Pierce';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'James Franco';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Noomi Rapace';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 60, idActor FROM Actor WHERE actorName = 'Javier Botet';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 61, idTag FROM Tag WHERE tagName = 'Ciencia Ficción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 61, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 61, idTag FROM Tag WHERE tagName = 'Terror';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 61, idActor FROM Actor WHERE actorName = 'Jake Gyllenhaal Rebecca Ferguson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 61, idActor FROM Actor WHERE actorName = 'Ryan Reynolds';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 61, idActor FROM Actor WHERE actorName = 'Hiroyuki Sanada';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 61, idActor FROM Actor WHERE actorName = 'Airyon Bakare';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 61, idActor FROM Actor WHERE actorName = 'Olga Dihovichnaya';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 61, idActor FROM Actor WHERE actorName = 'Naoko Mori';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 61, idActor FROM Actor WHERE actorName = 'Haruka Kuroda Camiel Warren-Taylor';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 62, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 62, idTag FROM Tag WHERE tagName = 'Romance';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 62, idTag FROM Tag WHERE tagName = 'Historia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 62, idTag FROM Tag WHERE tagName = 'Suceso Real';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 62, idActor FROM Actor WHERE actorName = 'Rosamund Pike';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 62, idActor FROM Actor WHERE actorName = 'Sam Riley';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 62, idActor FROM Actor WHERE actorName = 'Aneurin Barnard';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 62, idActor FROM Actor WHERE actorName = 'Anya Taylor-Joy';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 62, idActor FROM Actor WHERE actorName = 'Simon Russell Beale';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 62, idActor FROM Actor WHERE actorName = 'Jonathan Aris';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 62, idActor FROM Actor WHERE actorName = 'Corey Johnson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 62, idActor FROM Actor WHERE actorName = 'Tim Woodward';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 62, idActor FROM Actor WHERE actorName = 'Katherine Parkinson';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 63, idTag FROM Tag WHERE tagName = 'Comedia';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 63, idActor FROM Actor WHERE actorName = 'Chris O''Dowd';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 63, idActor FROM Actor WHERE actorName = 'Richard Ayoade';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 63, idActor FROM Actor WHERE actorName = 'Katherine Parkinson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 63, idActor FROM Actor WHERE actorName = 'Matt Berry';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 63, idActor FROM Actor WHERE actorName = 'Noel Fielding';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 63, idActor FROM Actor WHERE actorName = 'Peter Serafinowicz';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 63, idActor FROM Actor WHERE actorName = 'Gragam Linehan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 63, idActor FROM Actor WHERE actorName = 'Tom Binns';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 63, idActor FROM Actor WHERE actorName = 'Lewis Macleod';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 64, idTag FROM Tag WHERE tagName = 'Ciencia Ficción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 64, idTag FROM Tag WHERE tagName = 'Sci-Fi';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 64, idTag FROM Tag WHERE tagName = 'Fantasía';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 64, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 64, idTag FROM Tag WHERE tagName = 'Misterio';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'Katherine Parkinson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'Gemma Chan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'Emily Berrington';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'Lucy Carless';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'Colin Morgan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'Theo Stevenson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'Pixie Daves';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'Tom Goodman-Hill';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'Ivanno Jeremiah';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'Ruth Bradley';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'Will Tudor';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'Neil Maskell';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'Billy Jenkins';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'Bella Dayne';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'Thusitha Jayasumdera';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'Danny Webb';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'Carrie-Anne Moss';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 64, idActor FROM Actor WHERE actorName = 'William Hurt';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 65, idTag FROM Tag WHERE tagName = 'Acción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 65, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 65, idTag FROM Tag WHERE tagName = 'Suspenso';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 65, idActor FROM Actor WHERE actorName = 'Aaron Paul';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 65, idActor FROM Actor WHERE actorName = 'Dominic Cooper';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 65, idActor FROM Actor WHERE actorName = 'Imogen Poots';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 65, idActor FROM Actor WHERE actorName = 'Ramón Rodríguez';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 65, idActor FROM Actor WHERE actorName = 'Michael Keaton';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 65, idActor FROM Actor WHERE actorName = 'Rami Malek';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 65, idActor FROM Actor WHERE actorName = 'Kid Cudi';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 65, idActor FROM Actor WHERE actorName = 'Dakota Johnson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 65, idActor FROM Actor WHERE actorName = 'Harrison Gilbertson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 65, idActor FROM Actor WHERE actorName = 'Carmela Zumbado';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 65, idActor FROM Actor WHERE actorName = 'Jalil Jay Lynch';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 65, idActor FROM Actor WHERE actorName = 'Nick Chinlund';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 65, idActor FROM Actor WHERE actorName = 'Chad Randall';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 66, idTag FROM Tag WHERE tagName = 'Misterio';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 66, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 66, idTag FROM Tag WHERE tagName = 'Crimen';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 66, idTag FROM Tag WHERE tagName = 'Suspenso';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 66, idActor FROM Actor WHERE actorName = 'Kate Winslet';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 66, idActor FROM Actor WHERE actorName = 'Julianne Nicholson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 66, idActor FROM Actor WHERE actorName = 'Jean Smart';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 66, idActor FROM Actor WHERE actorName = 'Angourie Rice';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 66, idActor FROM Actor WHERE actorName = 'Evan Peters';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 66, idActor FROM Actor WHERE actorName = 'Sosie Bacon';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 66, idActor FROM Actor WHERE actorName = 'David Denman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 66, idActor FROM Actor WHERE actorName = 'Neal Huff';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 66, idActor FROM Actor WHERE actorName = 'James McArdle';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 66, idActor FROM Actor WHERE actorName = 'Guy Pearce';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 66, idActor FROM Actor WHERE actorName = 'Cailee Spaeny';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 66, idActor FROM Actor WHERE actorName = 'John Douglas Thompson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 66, idActor FROM Actor WHERE actorName = 'Joe Tippett';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 66, idActor FROM Actor WHERE actorName = 'Cameron Mann';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 66, idActor FROM Actor WHERE actorName = 'Chinasa Ogbuagu';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 67, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 67, idTag FROM Tag WHERE tagName = 'Música';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 67, idTag FROM Tag WHERE tagName = 'Suceso Real';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 67, idTag FROM Tag WHERE tagName = 'Historia';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 67, idActor FROM Actor WHERE actorName = 'Jamie Foxx';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 67, idActor FROM Actor WHERE actorName = 'Kerry Washington';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 67, idActor FROM Actor WHERE actorName = 'Regina King';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 67, idActor FROM Actor WHERE actorName = 'Harry Lennix';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 67, idActor FROM Actor WHERE actorName = 'Clifton Powell';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 67, idActor FROM Actor WHERE actorName = 'Bokeem Woodbine';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 67, idActor FROM Actor WHERE actorName = 'Sharon Warren';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 67, idActor FROM Actor WHERE actorName = 'C.J. Sanders';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 67, idActor FROM Actor WHERE actorName = 'Curtis Armstrong';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 68, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 68, idTag FROM Tag WHERE tagName = 'Ciencia Ficción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 68, idTag FROM Tag WHERE tagName = 'Fantasía';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Michaela Coel';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Daniel Lapaine';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Hannah John-Kamen';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Andrew Roux';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Claire Keelan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Sinéad Matthews';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Anna Wilson-Jones';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Paul Popplewell';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Julia Davis';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Ashely Thomas';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Kerrie Hayes';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Amy Beth Hayes';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Rebekah Staton';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Rhashan Stone';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Phoebe Fox';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Jimi Mistry';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Tobias Menzies';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Cherry Jones';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Alice Eve';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Susannah Fielding';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Demetri Goritsas';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Kadiff Kirwan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Sope Dirisu';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Jackson Bews';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Annabel Davis';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Billy Griffin Jr.';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Paul Lawrence Kitson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Jeff Mash Patrick Kennedy';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Lydia Wilson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Alastair Mackenzie';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Chetna Pandya';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Tuppence Middleton';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Ian Bonar';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Elisabeth Hopper';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Nick Bartlett';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Wunmi Mosaku';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Alex Lawther';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Jerome Flynn';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Susannah Doyle';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Madeline Brewer';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Ariane Labed';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Sarah Snook';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Michael Kelly';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Jola Bokinni';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Faye Marsay';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Benefict Wong';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Jonas Karlsson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Chloe Pirrie';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Eugene O''Hare';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Indira Ainger';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'James Lance';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'David Ajala';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Sarah Abbott';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Maxine Peake';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Jake Davies';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Clint Dyer';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Letitia Wright';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Babs Olusanmokun';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Georgina Campbell';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Jesse Plemons';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Jimmi Simpson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Aaron Paul';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Aldis Hodge';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Kiran Sonia Sawar';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Miley Cyrus';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Anthony Mackie';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Nicole Beharie';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Bryce Dallas Howard';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Mackenzie Davis';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 68, idActor FROM Actor WHERE actorName = 'Gugu Mbatha-Raw';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 69, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 69, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 69, idTag FROM Tag WHERE tagName = 'Crimen';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 69, idActor FROM Actor WHERE actorName = 'Simona Brown';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 69, idActor FROM Actor WHERE actorName = 'Eve Hewson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 69, idActor FROM Actor WHERE actorName = 'Toma Bateman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 69, idActor FROM Actor WHERE actorName = 'Robert Aramayo';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 69, idActor FROM Actor WHERE actorName = 'Tyler Howitt';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 69, idActor FROM Actor WHERE actorName = 'Georgie Glen';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 69, idActor FROM Actor WHERE actorName = 'Kamontip Krissy Ashton';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 69, idActor FROM Actor WHERE actorName = 'Rob Horrocks';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 69, idActor FROM Actor WHERE actorName = 'Joakim Skarli';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 70, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 70, idTag FROM Tag WHERE tagName = 'Sci-Fi';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 70, idTag FROM Tag WHERE tagName = 'Ciencia Ficción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 70, idTag FROM Tag WHERE tagName = 'Romance';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 70, idActor FROM Actor WHERE actorName = 'Joaquin Phoenix';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 70, idActor FROM Actor WHERE actorName = 'Scarlett Johansson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 70, idActor FROM Actor WHERE actorName = 'Amy Adams';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 70, idActor FROM Actor WHERE actorName = 'Rooney Mara';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 70, idActor FROM Actor WHERE actorName = 'Olivia Wilde';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 70, idActor FROM Actor WHERE actorName = 'Chris Pratt';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 70, idActor FROM Actor WHERE actorName = 'Matt Letscher';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 70, idActor FROM Actor WHERE actorName = 'Portia Doubleday';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 70, idActor FROM Actor WHERE actorName = 'Spike Jonze';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 71, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 71, idTag FROM Tag WHERE tagName = 'Acción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 71, idTag FROM Tag WHERE tagName = 'Romance';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 71, idActor FROM Actor WHERE actorName = 'Tom Cruise';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 71, idActor FROM Actor WHERE actorName = 'Jon Voight';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 71, idActor FROM Actor WHERE actorName = 'Emmanuelle Béart';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 71, idActor FROM Actor WHERE actorName = 'Henry Czerny';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 71, idActor FROM Actor WHERE actorName = 'Jean Reno';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 71, idActor FROM Actor WHERE actorName = 'Ving Rhames';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 71, idActor FROM Actor WHERE actorName = 'Kristin Scott Thomas';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 71, idActor FROM Actor WHERE actorName = 'Vanessa Redgrave';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 71, idActor FROM Actor WHERE actorName = 'Ingeborga Dapkünaitè';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 72, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 72, idTag FROM Tag WHERE tagName = 'Acción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 72, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 72, idTag FROM Tag WHERE tagName = 'Comedia';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 72, idActor FROM Actor WHERE actorName = 'Henry Cavill';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 72, idActor FROM Actor WHERE actorName = 'Armie Hammer Alicia Vikander';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 72, idActor FROM Actor WHERE actorName = 'Elizabeth Debicki';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 72, idActor FROM Actor WHERE actorName = 'Luca Calvani';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 72, idActor FROM Actor WHERE actorName = 'Sylvester Groth';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 72, idActor FROM Actor WHERE actorName = 'Hugh Grant';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 72, idActor FROM Actor WHERE actorName = 'Jared Harris';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 72, idActor FROM Actor WHERE actorName = 'Christian Berkel';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 72, idActor FROM Actor WHERE actorName = 'Misha Kuznetsov';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 72, idActor FROM Actor WHERE actorName = 'Guy Williams';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 72, idActor FROM Actor WHERE actorName = 'Marianna Di Martino';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 73, idTag FROM Tag WHERE tagName = 'Comedia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 73, idTag FROM Tag WHERE tagName = 'Ficción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 73, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 73, idTag FROM Tag WHERE tagName = 'Fantasía';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 73, idActor FROM Actor WHERE actorName = 'Dwayne Johnson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 73, idActor FROM Actor WHERE actorName = 'Kevin Hart';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 73, idActor FROM Actor WHERE actorName = 'Jack Black';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 73, idActor FROM Actor WHERE actorName = 'Karen Gillan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 73, idActor FROM Actor WHERE actorName = 'Nick Jonas';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 73, idActor FROM Actor WHERE actorName = 'Rhys Darby';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 73, idActor FROM Actor WHERE actorName = 'Bobby Cannavale';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 73, idActor FROM Actor WHERE actorName = 'Alex Wolff';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 73, idActor FROM Actor WHERE actorName = 'Ser''Darius Blain';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 73, idActor FROM Actor WHERE actorName = 'Madison Iseman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 73, idActor FROM Actor WHERE actorName = 'Morgan Turner';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 73, idActor FROM Actor WHERE actorName = 'Sean Buxton';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 73, idActor FROM Actor WHERE actorName = 'Mason Guccione';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 73, idActor FROM Actor WHERE actorName = 'Marin Hinkle';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 73, idActor FROM Actor WHERE actorName = 'Colin Hanks';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 21, idTag FROM Tag WHERE tagName = 'Comedia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 21, idTag FROM Tag WHERE tagName = 'Ficción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 21, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 21, idTag FROM Tag WHERE tagName = 'Fantasía';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Dwayne Johnson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Kevin Hart';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Jack Black';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Karen Gillan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Awkwafina';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Nick Jonas';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Rhys Darby';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Bobby Cannavale';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Alex Wolff';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Ser''Darius Blain';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Madison Iseman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Morgan Turner';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Sean Buxton';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Mason Guccione';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Marin Hinkle';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Colin Hanks';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Danny DeVito';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 21, idActor FROM Actor WHERE actorName = 'Danny Glover';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 74, idTag FROM Tag WHERE tagName = 'Comedia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 74, idTag FROM Tag WHERE tagName = 'Ficción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 74, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 74, idTag FROM Tag WHERE tagName = 'Fantasía';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 74, idActor FROM Actor WHERE actorName = 'Gal Gadot';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 74, idActor FROM Actor WHERE actorName = 'Chris Pine';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 74, idActor FROM Actor WHERE actorName = 'Kristen Wiig';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 74, idActor FROM Actor WHERE actorName = 'Pedro Pascal';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 74, idActor FROM Actor WHERE actorName = 'Robin Wright';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 74, idActor FROM Actor WHERE actorName = 'Connie Nielsen';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 74, idActor FROM Actor WHERE actorName = 'Lilly Aspell';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 74, idActor FROM Actor WHERE actorName = 'Amr Waked';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 74, idActor FROM Actor WHERE actorName = 'Kristoffer Polaha';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 75, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 75, idTag FROM Tag WHERE tagName = 'Acción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 75, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 75, idTag FROM Tag WHERE tagName = 'Crimen';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 75, idTag FROM Tag WHERE tagName = 'Drama';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'Ben Affleck';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'Anna Kendrick';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'J.K. Simmons';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'Jon Bernthal';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'Jeffrey Tambor';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'Cynthia Addai-Robinson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'John Lithgow';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'Jean Smart';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'Andy Umberger';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'Alison Wright';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'Daeg Faerch';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'Seth Lee';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'Tait Fletcher';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'Angel Giuffria';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'Ron Yuan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'Scott Hunter';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'Dennis Keiffer';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 75, idActor FROM Actor WHERE actorName = 'Jake Presley';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 76, idTag FROM Tag WHERE tagName = 'Suceso Real';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 76, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 76, idTag FROM Tag WHERE tagName = 'Historia';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 76, idActor FROM Actor WHERE actorName = 'Hugh Jackman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 76, idActor FROM Actor WHERE actorName = 'Allison Janney';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 76, idActor FROM Actor WHERE actorName = 'Geraldine Viswanathan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 76, idActor FROM Actor WHERE actorName = 'Alex Wolff';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 76, idActor FROM Actor WHERE actorName = 'Rafael Casal';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 76, idActor FROM Actor WHERE actorName = 'Stephen Spinella';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 76, idActor FROM Actor WHERE actorName = 'Annaleigh Ashford';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 76, idActor FROM Actor WHERE actorName = 'Ray Romano';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 76, idActor FROM Actor WHERE actorName = 'Hari Dhillon';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 76, idActor FROM Actor WHERE actorName = 'Jerremy Shamos';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 76, idActor FROM Actor WHERE actorName = 'Stephanie Kurtzuba';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 76, idActor FROM Actor WHERE actorName = 'Catherine Curtin';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 76, idActor FROM Actor WHERE actorName = 'Kathrine Narducci';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 76, idActor FROM Actor WHERE actorName = 'Ray Abruzzo';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 78, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 78, idTag FROM Tag WHERE tagName = 'Ciencia Ficción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 78, idTag FROM Tag WHERE tagName = 'Comedia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 78, idTag FROM Tag WHERE tagName = 'Familia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 78, idTag FROM Tag WHERE tagName = 'Acción';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 78, idActor FROM Actor WHERE actorName = 'Ben Stiller';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 78, idActor FROM Actor WHERE actorName = 'Robin Williams';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 78, idActor FROM Actor WHERE actorName = 'Carla Gugino';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 78, idActor FROM Actor WHERE actorName = 'Dick Van Dyke';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 78, idActor FROM Actor WHERE actorName = 'Steve Coogan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 78, idActor FROM Actor WHERE actorName = 'Jake Cherry';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 78, idActor FROM Actor WHERE actorName = 'Mickey Rooney';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 78, idActor FROM Actor WHERE actorName = 'Bill Cobbs';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 78, idActor FROM Actor WHERE actorName = 'Owen Wilson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 78, idActor FROM Actor WHERE actorName = 'Ricky Gervais';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 78, idActor FROM Actor WHERE actorName = 'Kim Raver';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 78, idActor FROM Actor WHERE actorName = 'Rami Malek';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 78, idActor FROM Actor WHERE actorName = 'Mizuo Peck';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 79, idTag FROM Tag WHERE tagName = 'Suceso Real';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 79, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 79, idTag FROM Tag WHERE tagName = 'Historia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 79, idTag FROM Tag WHERE tagName = 'Música';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 79, idActor FROM Actor WHERE actorName = 'Rami Malek';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 79, idActor FROM Actor WHERE actorName = 'Gwilym Lee';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 79, idActor FROM Actor WHERE actorName = 'Ben Hardy';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 79, idActor FROM Actor WHERE actorName = 'Joseph Mazzello';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 79, idActor FROM Actor WHERE actorName = 'Lucy Boynton';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 79, idActor FROM Actor WHERE actorName = 'Aidan Gillen';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 79, idActor FROM Actor WHERE actorName = 'Allen Leech';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 79, idActor FROM Actor WHERE actorName = 'Tom Hollander';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 79, idActor FROM Actor WHERE actorName = 'Mike Myers';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 80, idTag FROM Tag WHERE tagName = 'Música';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 80, idTag FROM Tag WHERE tagName = 'Musical';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 80, idTag FROM Tag WHERE tagName = 'Comedia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 80, idTag FROM Tag WHERE tagName = 'Romance';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 80, idTag FROM Tag WHERE tagName = 'Drama';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 80, idActor FROM Actor WHERE actorName = 'Julianne Hough';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 80, idActor FROM Actor WHERE actorName = 'Diego Boneta';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 80, idActor FROM Actor WHERE actorName = 'Tom Cruise';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 80, idActor FROM Actor WHERE actorName = 'Alec Baldwin';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 80, idActor FROM Actor WHERE actorName = 'Russell Brand';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 80, idActor FROM Actor WHERE actorName = 'Malin Åkerman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 80, idActor FROM Actor WHERE actorName = 'Paul Giamatti';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 80, idActor FROM Actor WHERE actorName = 'Bryan Cranston';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 80, idActor FROM Actor WHERE actorName = 'Catherine Zeta-Jones';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 80, idActor FROM Actor WHERE actorName = 'Mary J. Blige';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 80, idActor FROM Actor WHERE actorName = 'Erica Frene';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 80, idActor FROM Actor WHERE actorName = 'Shane Hartline';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 80, idActor FROM Actor WHERE actorName = 'James Martin Kelly';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 80, idActor FROM Actor WHERE actorName = 'Will Forte';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 80, idActor FROM Actor WHERE actorName = 'Eli Roth';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 81, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 81, idTag FROM Tag WHERE tagName = 'Misterio';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 81, idTag FROM Tag WHERE tagName = 'Sci-Fi';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 81, idActor FROM Actor WHERE actorName = 'Joel Courtney';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 81, idActor FROM Actor WHERE actorName = 'Elle Fanning';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 81, idActor FROM Actor WHERE actorName = 'Riley Griffiths';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 81, idActor FROM Actor WHERE actorName = 'Kyle Chandler';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 81, idActor FROM Actor WHERE actorName = 'Noah Emmerich';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 81, idActor FROM Actor WHERE actorName = 'AJ Michalka';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 81, idActor FROM Actor WHERE actorName = 'Ryan Lee';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 81, idActor FROM Actor WHERE actorName = 'Ron Eldard';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 81, idActor FROM Actor WHERE actorName = 'Gabriel Basso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 82, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 82, idTag FROM Tag WHERE tagName = 'Acción';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 82, idTag FROM Tag WHERE tagName = 'Sci-Fi';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 82, idActor FROM Actor WHERE actorName = 'Chris Pratt';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 82, idActor FROM Actor WHERE actorName = 'Bryce Dallas Howard';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 82, idActor FROM Actor WHERE actorName = 'Rafe Spall';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 82, idActor FROM Actor WHERE actorName = 'Justice Smith';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 82, idActor FROM Actor WHERE actorName = 'Daniella Pineda';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 82, idActor FROM Actor WHERE actorName = 'James Cromwell';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 82, idActor FROM Actor WHERE actorName = 'Toby Jones';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 82, idActor FROM Actor WHERE actorName = 'Ted Levine';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 82, idActor FROM Actor WHERE actorName = 'Jeff Goldblum';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 82, idActor FROM Actor WHERE actorName = 'BD Wong';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 82, idActor FROM Actor WHERE actorName = 'Geraldine Chaplin';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 82, idActor FROM Actor WHERE actorName = 'Isabella Sermon';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 82, idActor FROM Actor WHERE actorName = 'Kevin Layne';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 83, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 83, idTag FROM Tag WHERE tagName = 'Acción';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 83, idActor FROM Actor WHERE actorName = 'Harrison Ford';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 83, idActor FROM Actor WHERE actorName = 'Shia LaBeouf';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 83, idActor FROM Actor WHERE actorName = 'Cate Blanchett';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 83, idActor FROM Actor WHERE actorName = 'Karen Allen';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 83, idActor FROM Actor WHERE actorName = 'Ray Winstone';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 83, idActor FROM Actor WHERE actorName = 'John Hurt';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 83, idActor FROM Actor WHERE actorName = 'Jim Broadbent';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 83, idActor FROM Actor WHERE actorName = 'Igor Jijikine';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 83, idActor FROM Actor WHERE actorName = 'Dimitri Diatchenko';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 84, idTag FROM Tag WHERE tagName = 'Familia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 84, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 84, idTag FROM Tag WHERE tagName = 'Acción';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 84, idActor FROM Actor WHERE actorName = 'Sean Astin';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 84, idActor FROM Actor WHERE actorName = 'Josh Brolin';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 84, idActor FROM Actor WHERE actorName = 'Jeff Cohen';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 84, idActor FROM Actor WHERE actorName = 'Corey Feldman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 84, idActor FROM Actor WHERE actorName = 'Kerri Green';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 84, idActor FROM Actor WHERE actorName = 'Martha Plimpton';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 84, idActor FROM Actor WHERE actorName = 'Jonathan Ke Quan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 84, idActor FROM Actor WHERE actorName = 'Jogn matuszak';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 84, idActor FROM Actor WHERE actorName = 'Robert Davi';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 85, idTag FROM Tag WHERE tagName = 'Familia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 85, idTag FROM Tag WHERE tagName = 'Animación';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 85, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 85, idTag FROM Tag WHERE tagName = 'Comedia';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 85, idActor FROM Actor WHERE actorName = 'Owen Wilson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 85, idActor FROM Actor WHERE actorName = 'Bonnie Hunt';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 85, idActor FROM Actor WHERE actorName = 'Paul Newman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 85, idActor FROM Actor WHERE actorName = 'Larry the Cable Guy';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 85, idActor FROM Actor WHERE actorName = 'Tony Shalhoub';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 85, idActor FROM Actor WHERE actorName = 'Cheech Marin';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 85, idActor FROM Actor WHERE actorName = 'Michael Wallis';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 85, idActor FROM Actor WHERE actorName = 'George Carlin';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 85, idActor FROM Actor WHERE actorName = 'Paul Dooley';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 86, idTag FROM Tag WHERE tagName = 'Familia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 86, idTag FROM Tag WHERE tagName = 'Animación';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 86, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 86, idTag FROM Tag WHERE tagName = 'Comedia';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 86, idActor FROM Actor WHERE actorName = 'John DiMaggio';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 86, idActor FROM Actor WHERE actorName = 'Chris Miller';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 86, idActor FROM Actor WHERE actorName = 'Tom McGrath Danny Jacobs';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 86, idActor FROM Actor WHERE actorName = 'Andy Richter';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 86, idActor FROM Actor WHERE actorName = 'Nicole Sullivan Christopher Knights';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 86, idActor FROM Actor WHERE actorName = 'Wayne Knight';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 87, idTag FROM Tag WHERE tagName = 'Terror';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 87, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 87, idTag FROM Tag WHERE tagName = 'Suspenso';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 87, idActor FROM Actor WHERE actorName = 'Dale Midkiff';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 87, idActor FROM Actor WHERE actorName = 'Fred Gwynne';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 87, idActor FROM Actor WHERE actorName = 'Denise Crosby';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 87, idActor FROM Actor WHERE actorName = 'Brad Greenquist';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 87, idActor FROM Actor WHERE actorName = 'Michael Lombard';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 87, idActor FROM Actor WHERE actorName = 'Miko Hughes';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 87, idActor FROM Actor WHERE actorName = 'Blaze Berdahl';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 87, idActor FROM Actor WHERE actorName = 'Susan Blommaert';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 87, idActor FROM Actor WHERE actorName = 'Mara Clark';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 88, idTag FROM Tag WHERE tagName = 'Terror';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 88, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 88, idTag FROM Tag WHERE tagName = 'Suspenso';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 88, idActor FROM Actor WHERE actorName = 'Craig T. Nelson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 88, idActor FROM Actor WHERE actorName = 'JoBeth Williams';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 88, idActor FROM Actor WHERE actorName = 'Beatrice Straight';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 88, idActor FROM Actor WHERE actorName = 'Dominique Dunne';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 88, idActor FROM Actor WHERE actorName = 'Oliver Robins';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 88, idActor FROM Actor WHERE actorName = 'Heather O''Rourke';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 88, idActor FROM Actor WHERE actorName = 'Michael McManus';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 88, idActor FROM Actor WHERE actorName = 'Virginia Kiser';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 88, idActor FROM Actor WHERE actorName = 'Martin Casella';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 89, idTag FROM Tag WHERE tagName = 'Aventura';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 89, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 89, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 89, idTag FROM Tag WHERE tagName = 'Misterio';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 89, idActor FROM Actor WHERE actorName = 'Tom Hanks';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 89, idActor FROM Actor WHERE actorName = 'Audrey Tautou';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 89, idActor FROM Actor WHERE actorName = 'Ian McKellen';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 89, idActor FROM Actor WHERE actorName = 'Jean Reno';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 89, idActor FROM Actor WHERE actorName = 'Paul Bettany';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 89, idActor FROM Actor WHERE actorName = 'Alfred Molina';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 89, idActor FROM Actor WHERE actorName = 'Jürgen Prochnow';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 89, idActor FROM Actor WHERE actorName = 'Jean-Yves Berteloot';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 89, idActor FROM Actor WHERE actorName = 'Etienne Chicot';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 90, idTag FROM Tag WHERE tagName = 'Comedia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 90, idTag FROM Tag WHERE tagName = 'Familia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 90, idTag FROM Tag WHERE tagName = 'Acción';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 90, idActor FROM Actor WHERE actorName = 'Rowan Atkinson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 90, idActor FROM Actor WHERE actorName = 'Natalie Imbruglia';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 90, idActor FROM Actor WHERE actorName = 'Ben Miller';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 90, idActor FROM Actor WHERE actorName = 'John Malkovich';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 90, idActor FROM Actor WHERE actorName = 'Greg Wise';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 90, idActor FROM Actor WHERE actorName = 'Tasha de Vasconcelos';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 90, idActor FROM Actor WHERE actorName = 'Douglas McFerran';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 90, idActor FROM Actor WHERE actorName = 'Steve Nicolson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 90, idActor FROM Actor WHERE actorName = 'Terence Harvey';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 91, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 91, idTag FROM Tag WHERE tagName = 'Música';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 91, idTag FROM Tag WHERE tagName = 'Suceso Real';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 91, idActor FROM Actor WHERE actorName = 'Billy Crudup';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 91, idActor FROM Actor WHERE actorName = 'Frances McDormand';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 91, idActor FROM Actor WHERE actorName = 'Kate Hudson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 91, idActor FROM Actor WHERE actorName = 'Patrick Fugit';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 91, idActor FROM Actor WHERE actorName = 'Jason Lee';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 91, idActor FROM Actor WHERE actorName = 'Zoey Deschanel';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 91, idActor FROM Actor WHERE actorName = 'Michael Angarano';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 91, idActor FROM Actor WHERE actorName = 'Anna Paquin';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 91, idActor FROM Actor WHERE actorName = 'Fairuzza Balk';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 92, idTag FROM Tag WHERE tagName = 'Familia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 92, idTag FROM Tag WHERE tagName = 'Comedia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 92, idTag FROM Tag WHERE tagName = 'Música';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 92, idActor FROM Actor WHERE actorName = 'Jack Black';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 92, idActor FROM Actor WHERE actorName = 'Joan Cusack';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 92, idActor FROM Actor WHERE actorName = 'Mike White';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 92, idActor FROM Actor WHERE actorName = 'Sarah Silverman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 92, idActor FROM Actor WHERE actorName = 'Lee Wilkof';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 92, idActor FROM Actor WHERE actorName = 'Kate McGregor-Stewart';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 92, idActor FROM Actor WHERE actorName = 'Adam Pascal';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 92, idActor FROM Actor WHERE actorName = 'Suzzane Douglas';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 92, idActor FROM Actor WHERE actorName = 'Miranda Cosgrove';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 93, idTag FROM Tag WHERE tagName = 'Familia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 93, idTag FROM Tag WHERE tagName = 'Comedia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 93, idTag FROM Tag WHERE tagName = 'Música';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 93, idActor FROM Actor WHERE actorName = 'Macaulay Culkin';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 93, idActor FROM Actor WHERE actorName = 'Joe Pesci';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 93, idActor FROM Actor WHERE actorName = 'Daniel Stern';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 93, idActor FROM Actor WHERE actorName = 'John Heard';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 93, idActor FROM Actor WHERE actorName = 'Catherine O''Hara';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 93, idActor FROM Actor WHERE actorName = 'Roberts Blossom';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 93, idActor FROM Actor WHERE actorName = 'Devin Ratray';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 93, idActor FROM Actor WHERE actorName = 'Michael C. Maronna';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 93, idActor FROM Actor WHERE actorName = 'Hillary Wolf';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 94, idTag FROM Tag WHERE tagName = 'Familia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 94, idTag FROM Tag WHERE tagName = 'Comedia';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Owen Wilson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Vince Vaughn';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Will Ferrell';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Rose Byrne';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Aasif Mandvi';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Max Minghella';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Josh Brener';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Dylan O''Brien';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Tiya Sircar';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Tobit Raphael';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Josh Gad';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Jessica Szohr';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Rob Riggle';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Eric André';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Harvey Guillén';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Gary Anthony Williams';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Bruno Amato';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'B.J. Novak';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'Karen Ceesay';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 94, idActor FROM Actor WHERE actorName = 'John Goodman';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 95, idTag FROM Tag WHERE tagName = 'Familia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 95, idTag FROM Tag WHERE tagName = 'Comedia';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 95, idActor FROM Actor WHERE actorName = 'Rebecca Hazlewood';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 95, idActor FROM Actor WHERE actorName = 'Sacha Dhawan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 95, idActor FROM Actor WHERE actorName = 'Diedrich Bader';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 95, idActor FROM Actor WHERE actorName = 'Pippa Black';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 95, idActor FROM Actor WHERE actorName = 'Parvesh Ceena';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 95, idActor FROM Actor WHERE actorName = 'Thushari Jayasekera';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 95, idActor FROM Actor WHERE actorName = 'Ben Rappaport';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 95, idActor FROM Actor WHERE actorName = 'Guru Singh';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 95, idActor FROM Actor WHERE actorName = 'Rizwan Manji';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 95, idActor FROM Actor WHERE actorName = 'Anisha Nagarajan';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 95, idActor FROM Actor WHERE actorName = 'Carla Gallo';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 95, idActor FROM Actor WHERE actorName = 'Radhika Chaudhari';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 95, idActor FROM Actor WHERE actorName = 'Nicholas Logan';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 96, idTag FROM Tag WHERE tagName = 'Suspenso';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 96, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 96, idTag FROM Tag WHERE tagName = 'Terror';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 96, idActor FROM Actor WHERE actorName = 'Blake Lively';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 96, idActor FROM Actor WHERE actorName = 'Óscar Jaenada';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 96, idActor FROM Actor WHERE actorName = 'Janelle Bailley';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 96, idActor FROM Actor WHERE actorName = 'Chelsea Moody';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 96, idActor FROM Actor WHERE actorName = 'Angelo Josue Lozano Corzo';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 96, idActor FROM Actor WHERE actorName = 'José Manuel Trujillo Salas';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 96, idActor FROM Actor WHERE actorName = 'Brett Cullen';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 96, idActor FROM Actor WHERE actorName = 'Sedona Legge';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 96, idActor FROM Actor WHERE actorName = 'Pablo Calva';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 97, idTag FROM Tag WHERE tagName = 'Suceso Real';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 97, idTag FROM Tag WHERE tagName = 'Drama';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 97, idTag FROM Tag WHERE tagName = 'Suspenso';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 97, idActor FROM Actor WHERE actorName = 'Jason Clarke';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 97, idActor FROM Actor WHERE actorName = 'Josh Brolin';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 97, idActor FROM Actor WHERE actorName = 'Jake Gyllenhaal';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 97, idActor FROM Actor WHERE actorName = 'Jogn Hawkes';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 97, idActor FROM Actor WHERE actorName = 'Sam Worthington';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 97, idActor FROM Actor WHERE actorName = 'Emily Watson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 97, idActor FROM Actor WHERE actorName = 'Martin Henderson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 97, idActor FROM Actor WHERE actorName = 'Michael Kelly';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 97, idActor FROM Actor WHERE actorName = 'Keira Knightley';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 97, idActor FROM Actor WHERE actorName = 'Robin Wright';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 97, idActor FROM Actor WHERE actorName = 'Thomas M. Wright';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 97, idActor FROM Actor WHERE actorName = 'Clive StandenNaoko Mori';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 97, idActor FROM Actor WHERE actorName = 'Mia Goth';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 97, idActor FROM Actor WHERE actorName = 'Elizabeth Debicki';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 97, idActor FROM Actor WHERE actorName = 'Tom Goodman-Hill';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 97, idActor FROM Actor WHERE actorName = 'Vanessa Kirby';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 98, idTag FROM Tag WHERE tagName = 'Familia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 98, idTag FROM Tag WHERE tagName = 'Comedia';
...
INSERT INTO CatalogoTag (idCatalogo, idTag)
SELECT 98, idTag FROM Tag WHERE tagName = 'Fantasía';
-- Insertar Actores y asociarlos
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 98, idActor FROM Actor WHERE actorName = 'Raúl Juliá';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 98, idActor FROM Actor WHERE actorName = 'Anjelica Huston';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 98, idActor FROM Actor WHERE actorName = 'Christopher Lloyd';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 98, idActor FROM Actor WHERE actorName = 'Christina Ricci';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 98, idActor FROM Actor WHERE actorName = 'Carel Struycken';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 98, idActor FROM Actor WHERE actorName = 'Dan Hedaya';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 98, idActor FROM Actor WHERE actorName = 'Jimmy Workman';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 98, idActor FROM Actor WHERE actorName = 'Elizabeth Wilson';
...
INSERT INTO Reparto (idCatalogo, idActor)
SELECT 98, idActor FROM Actor WHERE actorName = 'Dana Ivey';
